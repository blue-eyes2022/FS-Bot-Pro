        ...
        try:
            ...
            if user.status == "kicked":
             ...
             await StreamBot.send_photo(
                chat_id=m.chat.id,
                photo="https://telegra.ph/file/fb50594e78f8d71291a82.jpg",
                caption="<i>Jay Shri Krishna! 𝙹𝙾𝙸𝙽 My CHANNEL 𝚃𝙾 𝚄𝚂𝙴 𝙼𝙴🔐</i>",
            ...
            await b.send_message(
                chat_id=m.chat.id,
                text="<i>𝓢𝓸𝓶𝓮𝓽𝓱𝓲𝓷𝓰 𝔀𝓮𝓷𝓽 𝔀𝓻𝓸𝓷𝓰</i> <b> <a href='https://t.me/techiesneh_bot'>CLICK HERE FOR SUPPORT </a></b>",
                parse_mode="HTML",
                disable_web_page_preview=True)
            return
    await StreamBot.send_photo(
        chat_id=m.chat.id,
        photo ="https://telegra.ph/file/fb50594e78f8d71291a82.jpg",
        caption =f'Hi {m.from_user.mention(style="md")}!,\nJAY SHRI KRISHNA..! I am Telegram File to Link Generator Bot with Channel support.\nSend me any file and get a direct download link and streamable link.!',
...
async def help_handler(bot, message):
    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            await bot.send_message(
                chat_id=message.chat.id,
                text="__Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍᴇ__ [Blue Eyes](https://t.me/techiesneh_bot).",
                parse_mode="markdown",
                disable_web_page_preview=True)
            return
...
<b> I also support Channels, add me to you Channel and send any media files and see miracle✨ also send /list to know all commands""",
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("💁‍♂️ DEV", url="https://t.me/techiesneh_bot")],
                [InlineKeyboardButton("💥 FOLLOW", url="https://github.com/blue-eyes2022")]
            ]
        )
    )
